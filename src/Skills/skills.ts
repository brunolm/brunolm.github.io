...
export const skills = [
  { name: 'JavaScript', years: currentYear - 2007, badge: 'gold' },
  ...
  { name: 'Next.js', years: 1, badge: 'none' },
  { name: 'Angular', years: 3, badge: 'none' },
  { name: 'GraphQL', years: 1, badge: 'none' },
  { name: 'jQuery', years: 4, badge: 'gold' },

  { name: 'ASP.NET', years: 8, badge: 'silver' },

  { name: 'PostgresSQL', years: 6, badge: 'none' },
  ...
  { name: 'Heroku', years: 6, badge: 'none' },
  { name: 'Vercel', years: 1, badge: 'none' },
  { name: 'Azure', years: 1, badge: 'none' },
  { name: 'AWS', years: 1, badge: 'none' },
]
